      ...
      child: Column(
        ...
        children: [
          ...
          if (permissionStatus == 'denied')
            ...
            Text(
                'Location access denied! Please allow weatehr guru to access your location from settings'),

          if (permissionStatus == 'deniedForever')
            Text(
                'Location access denied! Please allow weatehr guru to access your location from settings'),
          // ElevatedButton(onPressed: () => _requestPermission, child: Text('Allow location access')),
          if (permissionStatus == 'availed') Text('Permission availed'),
